...
const Checkout = () => {
  ...
  return (
    <div className="py-2 px-4 mt-45 sm:mt-20 md:px-10 flex flex-col space-y-4 bg-white/50 backdrop-blur-md lg:max-w-4xl mx-auto my-2 shadow-sm shadow-gray-900">
